...
int main(int argc, const char * argv[])
{
    ...
    // create a vertex buffer for floor to pass triangle to OpenGL
    GLuint vertexbufferFloor = 0;
    ...
    // create color buffer for floor to pass on colors
    GLuint colorbufferFloor = 0;
    ...
    GLuint programID_Floor = LoadShaders( "FloorShader.vs", "FloorShader.fs" );
    ...
    glm::mat4 View = glm::lookAt(
        glm::vec3(2,2,2), // Camera pos in World Space
    ...
    glm::mat4 mvp_floor = mvp;
    
    // handle for MVP uniform
    GLuint MatrixID = glGetUniformLocation(programID, "MVP");
    GLuint MatrixID_Floor = glGetUniformLocation(programID_Floor, "MVP");
    ...
    do {
        double current_time = glfwGetTime(), delta_transform = (current_time - old_time) * rotations_per_tick * 360;
        ...
        // draw floor
        glUseProgram(programID_Floor);
        glUniformMatrix4fv(MatrixID_Floor, 1, GL_FALSE, &mvp_floor[0][0]);
